...
import BudgetEntryTable from "@/app/(office)/office/dashboard/budget-management/create/_component/budget-entry-table";
      ...
      <div className="p-4 md:p-5 flex items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-6">
          ...
          <div className="text-right">
            ...
            <div className="mt-1 text-sm font-semibold text-primary-color">
              {head.remaining}
            </div>
          </div>
        </div>
