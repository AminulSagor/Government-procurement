...
import { ClipboardList, FileText, Laptop, Printer } from "lucide-react";
import { ReqItem } from "../_types/requisition-step.types";

export default function ReqItemsCard({
  items,
  onSpecsClick,
}: {
  items: ReqItem[];
  onSpecsClick?: (itemId: string) => void;
}) {
  return (
